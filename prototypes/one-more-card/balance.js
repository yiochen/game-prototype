...
export const BALANCE = {
  ...
  families: { base: 55, growth: 20, reactor: 15, wealth: 10 },
  base: {
  ...
  growth: {
    recall: { name: 'Recall', price: 7, weight: 45, multiplier: 1, linksPerSegmentCap: 3 },
    polish: { name: 'Polish', price: 5, weight: 35, linksPerSegment: 1 },
