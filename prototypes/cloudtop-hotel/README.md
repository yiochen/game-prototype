...
- `assets.js`, `assets/sprites/`: seven generated game/UI sheets plus one scenery atlas, totaling 68 frames: 48 room/actor/prop frames, 14 card illustrations and six scenery cutouts. Single-image assets provide the paper sky, cardboard tray and torn Dock banner. The manifest registers shared frames for Phaser and DOM card art plus individual scenery bounds. Original PNGs and prompts are preserved; WebP exports ship to players. See the [sprite-sheet guide](assets/sprites/README.md).
